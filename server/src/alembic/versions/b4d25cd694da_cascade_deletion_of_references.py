"""cascade deletion of references

Revision ID: b4d25cd694da
Revises: 495aae05274a
Create Date: 2017-06-07 13:40:47.579705
...
revision = 'b4d25cd694da'
down_revision = '495aae05274a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_unique_constraint(None, 'tag', ['name'], schema='public')
...
def downgrade():
    ...
    op.drop_constraint(None, 'tags_courses', schema='public', type_='foreignkey')
    op.create_foreign_key('tags_courses_tag_id_fkey', 'tags_courses', 'tag', ['tag_id'], ['id'])
    op.create_foreign_key('tags_courses_course_id_fkey', 'tags_courses', 'course', ['course_id'], ['id'])
    op.drop_constraint(None, 'tag', schema='public', type_='unique')
