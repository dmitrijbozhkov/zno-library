"""Cascade chapter deletion after course delete

Revision ID: 4009be37e439
Revises: 4a9fb109045b
Create Date: 2017-06-12 14:57:30.615839
...
revision = '4009be37e439'
down_revision = '4a9fb109045b'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.create_foreign_key('chapter_courseId_fkey', 'chapter', 'course', ['courseId'], ['id'])
    # ### end Alembic commands ###
