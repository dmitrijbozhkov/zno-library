...
Revision ID: 98a0b99d24c5
Revises: c4a53c016be5
Create Date: 2017-06-15 10:13:08.900435
...
revision = '98a0b99d24c5'
down_revision = 'c4a53c016be5'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('chapter', sa.Column('version', sa.Integer(), nullable=False))
...
def downgrade():
    ...
    op.drop_column('chapter', 'version')
    # ### end Alembic commands ###
