"""Course contents nullable

Revision ID: 3240529865c7
Revises: 70c63dbf3c01
Create Date: 2017-06-09 16:28:55.908001
...
revision = '3240529865c7'
down_revision = '70c63dbf3c01'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('course', 'contents',
