"""Changed course table

Revision ID: 70c63dbf3c01
Revises: 61575dea0c4a
Create Date: 2017-06-09 16:25:58.394070
...
revision = '70c63dbf3c01'
down_revision = '61575dea0c4a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('course', 'description',
               ...
               nullable=True)
    op.alter_column('course', 'preface',
               existing_type=sa.TEXT(),
               nullable=True)
...
def downgrade():
    ...
    op.add_column('course', sa.Column('rev', sa.INTEGER(), autoincrement=False, nullable=False))
